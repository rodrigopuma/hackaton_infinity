    ...
    <div className="flex flex-col items-center justify-center min-h-screen p-4 bg-gray-100 dark:bg-infinity-dark">
      ...
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="bg-white dark:bg-infinity-gray p-8 rounded-lg shadow-xl">
          ...
          <div className="mb-4">
            <label htmlFor="name" className="block text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">Nome Completo</label>
            <input
              id="name" type="text" placeholder="Seu nome" value={nome} onChange={(e) => setNome(e.target.value)}
          ...
          <div className="mb-4">
            ...
            <input
              id="email" type="email" placeholder="seu.email@exemplo.com" value={email} onChange={(e) => setEmail(e.target.value)}
              className="w-full p-3 bg-gray-50 dark:bg-infinity-dark border border-gray-300 dark:border-infinity-gray-light rounded-md text-gray-800 dark:text-infinity-text focus:outline-none focus:ring-2 focus:ring-infinity-red"
              required disabled={isLoading}
            />
          </div>
          <div className="mb-6">
            <label htmlFor="password" className="block text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">Senha</label>
            <input
              id="password" type="password" placeholder="********" value={senha} onChange={(e) => setSenha(e.target.value)}
              className="w-full p-3 bg-gray-50 dark:bg-infinity-dark border border-gray-300 dark:border-infinity-gray-light rounded-md text-gray-800 dark:text-infinity-text focus:outline-none focus:ring-2 focus:ring-infinity-red"
              required disabled={isLoading}
            />
          </div>
          <button type="submit" className="w-full bg-infinity-red text-white font-bold py-3 rounded-lg hover:brightness-110 transition-all disabled:bg-opacity-50" disabled={isLoading}>
