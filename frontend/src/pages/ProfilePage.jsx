...
function ProfilePage() {
  ...
  const handleUpdateProfile = async (updatedData) => {
    try {
      const response = await fetch(
        "https://organizainfinity.onrender.com/api/profile",
        {
          method: "PUT",
          headers: {
  ...
  return (
    <div>
      <h1 className="text-3xl font-bold text-gray-800 dark:text-infinity-text mb-8">
        Meu Perfil
      </h1>
      ...
      <div className="bg-white dark:bg-infinity-gray p-8 rounded-lg shadow-lg flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="flex-1 text-center md:text-left">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-infinity-text">
            {user.name}
          </h2>
        ...
        <div>
          ...
          <button
            ...
            className="flex items-center gap-2 py-2 px-4 rounded-md text-gray-700 dark:text-infinity-text bg-gray-200 dark:bg-infinity-gray-light hover:bg-gray-300 dark:hover:bg-infinity-red transition-colors"
          >
            <FiEdit />
            Editar Perfil
          </button>
